...
Skip the skill-position optimism. Skip the “Shane Steichen finds answers” cliché. Indianapolis is a quarterback market wearing a football team’s jersey — and the primary number is **8.5**.
...
The primary desk number is **8.5**. Softer 7.5 boards still appear with Over juice in the −125 to −140 range; treat those as alts, not the main thesis. At **8.5**, you are no longer buying a “cleared for camp” discount. You are buying a full-season Jones who looks like 2025’s first-half version for enough Sundays to clear nine.
...
**Handicapper’s Note**  
Fair number: uncertain — model ~8.4 if Jones is full-season healthy; research-adjusted ~7.3–7.8 until camp durability is proven  
Market number: 8.5 (primary); 7.5 still available at some shops  
Lean: **Pass**  
Confidence: 1/5  
Key risk: One clean August stretch creates Over stampedes that ignore how fast an Achilles year can still go sideways in October.
