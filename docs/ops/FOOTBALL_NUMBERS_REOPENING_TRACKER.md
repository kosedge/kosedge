...
Workstream **NFL regression investigation** is `IN_PROGRESS`. Reopening packet 2026-09-16 is **NO-GO CLEAR**: SYSTEM INTEGRITY **PASS**, PREDICTIVE VALIDATION **FAIL**, CURRENT SLATE SANITY/PROVENANCE **PASS** (flags). Release stays BLOCKED. `production_promote=false`. Coming soon stays. Ryan CLEAR required.
...
| Predictive validation | FAIL        | Frozen eval **run** on SHA `153b6a884a8e` / packaged EPA / overlays OFF. No tuning. W1 n=16: EPA margin MAE **12.60** / total **13.25** vs floors 9.5 / 10.5; market-implied 5.69; July-31 12.19 / 13.51 (margin regressed). Protocol thin — cannot YELLOW/GREEN. W-L 7.70 circular refuse. [`predictive_validation.json`](../../data/ops/nfl-reopening-packet-20260916/predictive_validation.json). | Thin n + missed floors + margin vs July-31 regression. Do not ATS-fit. Do not retune.                                                                            | Validation Lead      | Stay dark. Do not reopen on this FAIL.                                                                                                  | 2026-09-16   |
...
| Release — spread      | BLOCKED     | #561 Coming soon; `NFL_EDGE_BOARD_PUBLIC_ENABLED=false`. Packet **NO-GO CLEAR**: integrity PASS, predictive **FAIL**, slate PASS with flags. [`NFL_PRODUCTION_REOPENING_PACKET_2026-09-16.md`](./NFL_PRODUCTION_REOPENING_PACKET_2026-09-16.md).                                                                                                                                                                                  | No Ryan CLEAR. Predictive FAIL. Website BLOCKED.                                                                                                                  | CoS                  | Review the packet. Do not enable NFL spread from this PR. If later CLEAR: fair → overview → Edge Board last.                            | 2026-09-16   |
