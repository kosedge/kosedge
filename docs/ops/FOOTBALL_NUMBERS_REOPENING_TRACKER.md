...
Workstream **NFL regression investigation** is `IN_PROGRESS`. Reopening packet 2026-09-16 recommends **HOLD**. Candidate path integrity PASS; live isolation FAIL; Release stays BLOCKED. `production_promote=false`. Coming soon stays. Ryan CLEAR required.

| Gate                  | Status      | Evidence                                                                                                                                                                                                                                                                                                                                                                                                                        | Unresolved blocker                                                                                                                                                | Owner                | Next action                                                                                                                             | Last updated |
| --------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- | --------------------------------------------------------------------------------------------------------------------------------------- | ------------ |
| Input integrity       | IN_PROGRESS | Live attest 2026-09-16T14:55:38Z: Railway `current_week=2`, readiness `sample_size=20` / `last_game_date=2026-09-15` (still 503 no-go). [`live_stamps.json`](../../data/ops/nfl-reopening-packet-20260916/live_stamps.json). #564 ingest path remains. 47/48 upcoming fairs still `projection_created_at=2026-07-31`.                                                                                                                                 | Live fair book is still the July-31 run (`active_run_id=null`). Reopen-grade identity/venue/exclusion pack still incomplete.                                      | Alex                 | Do not paint live rows. Candidate filter rejects July-31. Live remat to packet `run_id` is Ryan CLEAR, not this PR.                     | 2026-09-16   |
| Calculation integrity | IN_PROGRESS | Packet [`NFL_PRODUCTION_REOPENING_PACKET_2026-09-16.md`](./NFL_PRODUCTION_REOPENING_PACKET_2026-09-16.md): candidate path **PASS** (EPA, overlays OFF, ATL@PIT remat −0.76, W-L refuse, July-31 rejected as input). Live isolation **FAIL**. Reopen Gate 1 **FAIL**. Integrity sha `3e9b4a8a…`. Scoring equation **not** edited. #570 KE R&D out of scope.                                                                        | Live Railway still serves July-31 + one unauthorized DET@BUF remat (`run_id` null). Overlays OFF until Ryan CLEAR. Not a reopen PASS.                             | Alex                 | Keep overlays OFF (`unlock_overlays` Ryan only). Do not retune the equation. Do not flip Coming soon.                                   | 2026-09-16   |
| Predictive validation | IN_PROGRESS | Frozen protocol v1.0 inherited (Predictive YELLOW / Market Edge GREEN confirmatory / Influence LIMITED). W1 OOS n=16: EPA margin MAE 12.60 / total 13.25 vs July-31 12.19 / 13.51. No ATS fitting. No coefficient changes. [`frozen_eval.json`](../../data/ops/nfl-reopening-packet-20260916/frozen_eval.json).                                                                                                              | n=16 below protocol min N=200. Verdict `IN_PROGRESS_THIN`. W-L W1 MAE is circular (post-game 1-0/0-1) and is refused. Protocol ≠ PASS.                            | Validation Lead      | Do not retune. Do not ATS-fit. Full unused holdout still required before predictive PASS.                                               | 2026-09-16   |
| Production rehearsal  | IN_PROGRESS | Private shadow W2–W4 (`run_id=nfl-reopening-packet-20260916-shadow`): Market → KE fair + projected score. Gate 2 sanity **PASS**, no −37/~81. W2 flags: CAR@ATL, CLE@TB, DET@BUF, IND@KC, MIA@SF, NO@BAL. [`shadow_slate.json`](../../data/ops/nfl-reopening-packet-20260916/shadow_slate.json).                                                                                                                              | Single snapshot, not a weekly-update drill with injuries ON or missing-data paths. Overlays remain OFF.                                                           | Platform Reliability | Keep shadow INTERNAL. Do not replace production means. Injury/missing-data rehearsal still open.                                        | 2026-09-16   |
| Website verification  | BLOCKED     | Parked surfaces: #561. Prior display-contract work (not a reopen verify): [`docs/incidents/INC-2026-09-08-NFL-EDGE-BOARD-CUSTOMER-TRUTH/`](../incidents/INC-2026-09-08-NFL-EDGE-BOARD-CUSTOMER-TRUTH/). SOP v1.1 inactive suppress still stamps when numbers are shown. Packet 2026-09-16 recommends HOLD.                                                                                                                                 | No approved NFL numbers to paint. Coming soon is not this gate.                                                                                                   | Product              | After calculation + predictive PASS **and** Ryan CLEAR, INTERNAL-verify every parked NFL URL + assemble.                                | 2026-09-16   |
| Release — spread      | BLOCKED     | #561 Coming soon; `NFL_EDGE_BOARD_PUBLIC_ENABLED=false`. Packet 2026-09-16 **HOLD** — not GO. [`NFL_PRODUCTION_REOPENING_PACKET_2026-09-16.md`](./NFL_PRODUCTION_REOPENING_PACKET_2026-09-16.md).                                                                                                                                                                                                                              | Upstream NFL gates not PASS. Live July-31 leak. Ryan CLEAR not given.                                                                                             | CoS                  | Review the packet. Do not enable NFL spread from this PR.                                                                               | 2026-09-16   |
| Release — total       | BLOCKED     | Totals PLAY sat: `NFL_SPREAD_PLAY_LOCKED.md`. Coming soon #561. Packet HOLD; compressed totals flagged (DET@BUF 46.1 vs mkt 54.5).                                                                                                                                                                                                                                                                                             | Totals may stay dark after spreads CLEAR. Totals need their own predictive PASS.                                                                                  | CoS                  | Do not piggyback totals on a spread CLEAR.                                                                                              | 2026-09-16   |
