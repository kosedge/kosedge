...
Workstream **NFL regression investigation** is `IN_PROGRESS`. Reopening packet 2026-09-16 is **HOLD public / NO CLEAR**: SYSTEM INTEGRITY **PASS**, PREDICTIVE VALIDATION **PARTIAL** (fail-closed; W2 no outcomes), CURRENT SLATE SANITY/PROVENANCE **PASS (16/17)**. Release stays BLOCKED. `production_promote=false`. Coming soon stays. STOP for Ryan.

| Gate                  | Status      | Evidence                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Unresolved blocker                                                                                        | Owner                | Next action                                                                                                  | Last updated |
| --------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- | -------------------- | ------------------------------------------------------------------------------------------------------------ | ------------ |
| Input integrity       | IN_PROGRESS | Alex live `git_sha=153b6a884a8e` (read-only `/health` confirm). W2 remat dates 2026-09-17/20/21 SUCCESS, 17 games, packaged EPA, dampened @ `completed_reg=16`. Receipts: [`alex_live_receipts.json`](../../data/ops/nfl-reopening-packet-20260916/alex_live_receipts.json). www fair-lines still 503.                                                                                                                                                                    | Identity/venue/exclusion pack still incomplete. Live remats cited, not reinvented. Board still dark.      | Alex                 | Do not paint customer boards. Keep overlays OFF. Ryan CLEAR is the next input-to-release step.               | 2026-09-16   |
| Calculation integrity | PASS        | Gate 1 **PASS**. ATL@PIT EPA **−0.76** vs W-L **−7.55** (Δ −6.79); overlay_zero; #564 integrity sha `3ee91339…` **STILL_VALID**; double_count pass. Packet [`NFL_PRODUCTION_REOPENING_PACKET_2026-09-16.md`](./NFL_PRODUCTION_REOPENING_PACKET_2026-09-16.md). Scoring equation **not** edited. #570 KE R&D out of scope.                                                                                                                                                 | Board reopen remains **NO-GO** (no Ryan CLEAR). Overlays OFF. Not a Release PASS.                         | Alex                 | Integrity evidence stands. Do not retune. Do not flip Coming soon.                                           | 2026-09-16   |
| Predictive validation | FAIL        | Alex W2 freeze **PARTIAL** (no outcomes/closing). Filed historical OOS diagnostic **`MODEL_SIGNAL_WEAK`** (research only; SHA `153b6a88`; packaged EPA; overlays OFF; n=586 spread MAE 10.9463 vs market 9.7474). W1 n=16 MAE 12.60 / 13.25. Not a CLEAR. [`historical-oos/HISTORICAL_OOS_DIAGNOSTIC.md`](../../data/ops/nfl-reopening-packet-20260916/historical-oos/HISTORICAL_OOS_DIAGNOSTIC.md). Tracker vocab has no PARTIAL — row is FAIL (fail-closed, stay dark). | W2 ungradeable; historical OOS is MODEL_SIGNAL_WEAK and cannot carry PASS. Do not ATS-fit. Do not retune. | Validation Lead      | Stay dark. HOLD public / NO CLEAR.                                                                           | 2026-09-16   |
| Production rehearsal  | IN_PROGRESS | Gate 2 slate shadow **PASS** — Alex live 17 games (2026-09-17/20/21) SUCCESS; packaged EPA; dampened @ 16. This PR research shadow supporting only. Coming soon untouched.                                                                                                                                                                                                                                                                                                | Not a weekly-update drill with injuries ON or missing-data paths. Overlays remain OFF.                    | Platform Reliability | Keep shadow INTERNAL. Do not replace production means.                                                       | 2026-09-16   |
| Website verification  | BLOCKED     | Parked surfaces: #561. Packet Gate 4 **BLOCKED**. Coming soon is not this gate.                                                                                                                                                                                                                                                                                                                                                                                           | No approved NFL numbers to paint. No Ryan CLEAR.                                                          | Product              | After Ryan CLEAR, INTERNAL-verify every parked NFL URL + assemble.                                           | 2026-09-16   |
| Release — spread      | BLOCKED     | #561 Coming soon; `NFL_EDGE_BOARD_PUBLIC_ENABLED=false`. Packet **HOLD public / NO CLEAR**: integrity PASS, predictive **PARTIAL** (fail-closed), slate 16/17. [`NFL_PRODUCTION_REOPENING_PACKET_2026-09-16.md`](./NFL_PRODUCTION_REOPENING_PACKET_2026-09-16.md).                                                                                                                                                                                                        | No Ryan CLEAR. Predictive PARTIAL/fail-closed. Website BLOCKED.                                           | CoS                  | Review the packet. Do not enable NFL spread from this PR. If later CLEAR: fair → overview → Edge Board last. | 2026-09-16   |
| Release — total       | BLOCKED     | Totals PLAY sat: `NFL_SPREAD_PLAY_LOCKED.md`. Coming soon #561. Packet board NO-GO.                                                                                                                                                                                                                                                                                                                                                                                       | Totals may stay dark after spreads CLEAR. Totals need their own predictive PASS.                          | CoS                  | Do not piggyback totals on a spread CLEAR.                                                                   | 2026-09-16   |
| Release — ML          | BLOCKED     | Product 2026-09-17 independent gate `NFL_FAIR_LINES_PUBLIC_ML_ENABLED=false`. Cert slot unbound. Coming soon stays. [`NFL_FAIR_LINES_PRODUCTION_CERT_PRODUCT_2026-09-17.md`](./NFL_FAIR_LINES_PRODUCTION_CERT_PRODUCT_2026-09-17.md).                                                                                                                                                                                                                                     | No Ryan / CoS CLEAR. Independent of spread/total. Approver slots empty.                                   | CoS                  | Do not piggyback ML on a spread CLEAR.                                                                       | 2026-09-17   |
...
| Rollback                                          | NOT_STARTED | Reversible flags documented in #561 (public constant or INTERNAL). Product 2026-09-17 Fair Lines rollback written in [`NFL_FAIR_LINES_PRODUCTION_CERT_PRODUCT_2026-09-17.md`](./NFL_FAIR_LINES_PRODUCTION_CERT_PRODUCT_2026-09-17.md) — not a cleared-sport drill.                                            | No drilled rollback of a **cleared** sport (flag off + stale-page check) because nothing is cleared.                     | Platform Reliability          | Written rollback: flags false, cert unbound, assemble 503/empty, pages Coming soon, no remat. Drill only after a CLEAR. | 2026-09-17   |
| NFL Fair Lines cert-binding harness               | PASS        | Product 2026-09-17: independent spread/ML/total gates default false; cert bind fail-closed on missing/mismatched/stale `run_id`+sha256; PLAY/Kelly suppressed. Smoke `scripts/nfl/nfl-fair-lines-production-cert-smoke.sh`. Packet approvers empty. **Not a reopen.**                                         | Certified slot remains unbound. No Ryan / CoS CLEAR.                                                                     | Product                       | Keep public + market gates false. Do not stamp a production hash without CLEAR.                                         | 2026-09-17   |
...
- Shared kill switch today parks **both** markets per sport. Product 2026-09-17 added independent NFL Fair Lines gates (`NFL_FAIR_LINES_PUBLIC_SPREAD_ENABLED` / `_ML_` / `_TOTAL_`) — **all default false**. They are not a CLEAR. Do not flip any one market without its own Release row + CoS / Ryan slot.
