...
Workstream **NFL regression investigation** is `IN_PROGRESS`. Reopening packet 2026-09-16 (Alex live fold) is **CONDITIONAL**: remat+integrity **GO**, board reopen **NO-GO**. Release stays BLOCKED. `production_promote=false`. Coming soon stays. Ryan CLEAR required.
...
| Predictive validation | NOT_STARTED | Alex live FROZEN_EVAL **NOT_STARTED**. Protocol exists: [`docs/lab/NFL_SPREAD_VALIDATION_PROTOCOL_v1.md`](../lab/NFL_SPREAD_VALIDATION_PROTOCOL_v1.md). Research-only W1 OOS in this PR is **not** the freeze.                                                                                                                                                                                                                      | No frozen reopen eval has been run against predefined criteria for the candidate that would be shown. Protocol ≠ PASS.                                            | Validation Lead      | Do not ATS-fit. Do not retune. Run the unused/frozen package before predictive PASS.                                                    | 2026-09-16   |
...
| Release — spread      | BLOCKED     | #561 Coming soon; `NFL_EDGE_BOARD_PUBLIC_ENABLED=false`. Packet **CONDITIONAL**: integrity GO, board **NO-GO**. [`NFL_PRODUCTION_REOPENING_PACKET_2026-09-16.md`](./NFL_PRODUCTION_REOPENING_PACKET_2026-09-16.md).                                                                                                                                                                                                               | No Ryan CLEAR. Predictive NOT_STARTED. Website BLOCKED.                                                                                                           | CoS                  | Review the packet. Do not enable NFL spread from this PR. If later CLEAR: fair → overview → Edge Board last.                            | 2026-09-16   |
