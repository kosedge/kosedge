...
**Generated:** 2026-09-04T04:46:39.131508+00:00  
...
| Market Edge Evidence | **GREEN** | [confirmatory window 2024–2025] play_band_all ATS 0.7313 n=227; ROI 0.3961; CLV+ 0.6117 n_clv_move=206 (≥200). (primary unused 2025 alone: YELLOW.) |
| Evidence Quality | **GREEN** | overall_n=1693; play_band n=227; CLV coverage 90.75%; contradicting regimes=0. |

**Subscriber Influence (recommendation to CoS → Ryan):** **LIMITED**  

Protocol §9 LIMITED: Market Edge GREEN rides confirmatory 2024–25 window; primary unused 2025 alone is YELLOW (CLV n below product floor). Scope claim to confirmatory window / PLAY-band only. Clean-era 2020–22 CLV+ fails (~0.45). YES would overclaim money-influence when primary OOS year does not clear product CLV floor. Evidence only — no live tag flip.
