...
- **Forbidden for this candidate in this phase:** Test-A scoring, pocket_2025, sealed 2024–25 holdout, any production board, any KEI/fair-line publication.
...
- Non-boolean `neutral_site` values
- Market/injury/open-shrink features
- Any change to parent `B2-PACE-v1` behavior
- KosEdge August 31 research ratings as Week 2 KEI / production fair
