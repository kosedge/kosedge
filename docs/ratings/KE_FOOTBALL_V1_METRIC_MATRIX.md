...
**Taxonomy amend:** [`KE_FOOTBALL_V1_PROVENANCE_AMEND_2026-09-15.md`](./KE_FOOTBALL_V1_PROVENANCE_AMEND_2026-09-15.md)  
...
Phase 1 implements measurement + PIT ADJUSTED EPA. Team Strength / scoring / market / UI stay out.
...
| ADJUSTED | Deterministic PIT opponent adjustment of DERIVED       |
| MODELED  | Fitted / estimated (not Phase 1)                       |
...
| `ke.opp_adj_epa`   | Opponent-Adjusted EPA    | ADJUSTED (Phase 1 PIT SOS); MODELED = #560 ridge only | EPA/play                    | diagnostics ≠ this ID                                               | PROXY vendor SP+            | #560 ADVANCE stays MODELED, not this ID | **YES** (ADJUSTED, research)   | **YES_RESEARCH** (ADJUSTED) |
...
| `ke.opp_adj_epa`   | team-game y, opponent book      | OT on ADJUSTED/MODELED; incomplete PBP; same-game LOO | Phase 1: `raw − (opp_other − league)` (ADJUSTED) | **this is it** | no λ in Phase 1; #560 ridge stays MODELED   | none inside ADJUSTED                 | EPA/play         | `week < W` only | weekly research              | next-game O/D EPA vs unadj & league; no ATS         | DATA_INSUFFICIENT if opp has no other game  |
