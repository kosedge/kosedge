...
| --- | --- | --- |
| **Class** | **PARTIAL** (vendor SP+ carry, real opponent-adjusted *source*, not owned, stale to final-2025) | Warehouse 4-iter EPA: **REAL_UNVALIDATED** / unused. #560 joint-ridge EPA: **REAL_UNVALIDATED** (holdout-sealed as *next-game EPA*, not as KE Ratings or points) |
...
*End of football inventory. 2026-09-15. No implementation.*
