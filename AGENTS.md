...
1. **GitHub → Vercel**: Vercel GitHub integration auto-deploys on push/PR (project `kosedge`, root `apps/web`). **Production branch:** `restore-working-ui` (Preview/Production GitHub Environments).
