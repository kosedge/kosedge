...
Writing style: Short audit notes. Tables over prose. Never invents a market to make a lean look clean.
...
- Edge Threshold Discipline (`style-bible.md` / `ai-writer-team.mdc`)
...
4. Fix mismatches: update title/Market/Handicapper’s Note primary numbers; recalibrate lean when |fair − market| is thin or Model vs market conflict is material → **Pass**.
