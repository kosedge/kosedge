  ...
  return (
    <main className="min-h-screen bg-[#070A0F] text-[#E9EEF5]">
      ...
      <section className="mx-auto max-w-4xl px-6 pt-10 pb-20">
        ...
        <p className="mt-4 text-white/70">Built on Data. Driven by Edge.</p>
        <p className="mt-2 text-white/70">
          We don&apos;t sell picks. We build models.
        </p>
        <p className="mt-4 text-white/70">
          Every projection, prop, and edge on this platform comes from a
          structured data pipeline designed to identify mispriced numbers in the
          betting market.
        </p>
        <p className="mt-2 text-white/70">
          Sportsbooks price games. We price them too. Where there&apos;s
          separation — there&apos;s opportunity.
        </p>
        ...
        <p className="mt-3 text-white/70">
          At the core of our process is one principle: Expected Value (EV) over
          Emotion.
        </p>
        <p className="mt-2 text-white/70">For every game, prop, or total:</p>
        ...
        <p className="mt-3 text-white/70">
          If it doesn&apos;t meet the threshold — it doesn&apos;t make the
          board.
        </p>
        <p className="mt-2 text-white/70">
        ...
        <p className="mt-3 text-white/70">Our models integrate:</p>
        <ul className="mt-2 list-disc list-inside space-y-1 text-white/70">
        ...
        <p className="mt-4 text-white/70">
          For MLB specifically, we build from the plate appearance level upward
          — projecting:
        </p>
        <ul className="mt-2 list-disc list-inside space-y-1 text-white/70">
        ...
        <p className="mt-3 text-white/70">
          These simulations aggregate into: Player props, team totals, run
          lines, moneyline projections.
        </p>
        <p className="mt-2 text-white/70">
        ...
        <p className="mt-3 text-white/70">
          Not every difference between our projection and the sportsbook number
          is actionable.
        </p>
        ...
        <p className="mt-2 text-white/70">
          Performance isn&apos;t a screenshot. It&apos;s recorded. And the
        ...
        <p className="mt-3 text-white/70">
          The biggest leak in sports betting isn&apos;t information. It&apos;s
          behavior.
        </p>
        <p className="mt-2 text-white/70">
          This platform is built for: Structured bettors, process-driven users,
          people who want to level up.
        </p>
        ...
        <p className="mt-3 text-white/70">Built on data. Driven by edge.</p>
