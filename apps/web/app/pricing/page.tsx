...
import { isOpenAccessPreviewEnabled, isProUser } from "@/lib/auth/pro";

export const dynamic = "force-dynamic";

export default async function PricingPage() {
  const openAccessPreview = isOpenAccessPreviewEnabled();
  if (!openAccessPreview && (await isProUser())) {
  ...
  return (
    <div className="min-h-screen bg-[#070A0F] text-gray-100 font-inter relative overflow-hidden">
      ...
      <main className="relative z-10 w-full px-5 sm:px-6 pt-10 pb-16">
        ...
        <div className="mt-10">
          <ProPricing openAccessPreview={openAccessPreview} />
        </div>
