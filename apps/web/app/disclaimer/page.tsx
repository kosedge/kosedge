    ...
    <main className="min-h-screen bg-[#070A0F] text-[#E9EEF5]">
      ...
      <section className="mx-auto max-w-4xl px-6 pt-10 pb-20">
        ...
        <div className="mt-6 space-y-4 text-white/70">
          ...
          <p>
            Nothing on this site is financial, legal, or betting advice. You are
            responsible for your own decisions and for complying with the laws
            where you live. In many jurisdictions you must be 21 or older to
            gamble.
          </p>
          <p>
            We do not guarantee any results. Past performance does not guarantee
            future outcomes. Use this platform at your own risk.
          </p>
        </div>
      </section>
    </main>
