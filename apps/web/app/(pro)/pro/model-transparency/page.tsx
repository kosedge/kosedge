  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-10">
      ...
      <p className="mt-2 text-kos-text/70">
        Model vs open, model vs close, ROI, EV capture %, sport segmented
        performance, market segmented performance.
      </p>
        ...
        {[
          {
            label: "Model vs Open",
            value: "—",
            desc: "Projection vs opening line",
          },
          {
            label: "Model vs Close",
            value: "—",
            desc: "Projection vs closing line",
          },
          { label: "ROI", value: "—", desc: "Return on investment" },
          {
            label: "EV Capture %",
            value: "—",
            desc: "Expected value realized",
          },
          {
            label: "Sport Segmented",
            value: "—",
            desc: "Performance by sport",
          },
          {
            label: "Market Segmented",
            value: "—",
            desc: "Performance by market",
          },
        ].map((m) => (
          <div
            key={m.label}
          ...
          >
            ...
            <div className="mt-1 text-2xl font-semibold text-kos-text">
              {m.value}
            </div>
