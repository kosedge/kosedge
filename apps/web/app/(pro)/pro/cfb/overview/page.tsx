...
export default async function CfbOverviewPage() {
  const desk = getSportDeskConfig("cfb");
  const content = buildSportOverviewContent("cfb", "CFB");
  const slate = await loadOverviewSlateGames("cfb");
  ...
  return (
    <OverviewSportShell
      ...
      toolsSubtitle="Project Game, projections, futures, and CFB research desks."
      extraBelowSections={
        <>
          ...
          <section className="mt-6 grid gap-4 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-black/30 p-5">
              ...
              <p className="mt-1 text-xs text-kos-text/55">
                KosEdge + date only. Research language. {teamPreviews.length}{" "}
                team · {confPreviews.length} conference.
              </p>
