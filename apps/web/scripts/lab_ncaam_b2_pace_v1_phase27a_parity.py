...
def main() -> None:
    ...
    receipt: Dict[str, Any] = {
        ...
        "historical_production_base": PRODUCTION_BASE,
        "acceptance_base": acceptance_base,
        "acceptance_base_ref": ACCEPTANCE_BASE_REF,
        "acceptance_merge_base": acceptance_merge_base,
        "behind_vs_acceptance_base": behind_acceptance,
        "head_sha": head,
