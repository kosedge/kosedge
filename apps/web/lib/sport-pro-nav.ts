...
const SPORT_NAV: Record<SportKey, SportNavConfig> = {
  ...
  cfb: {
    ...
    tools: [
      ...
      { href: "/pro/model-tracker?sport=cfb", label: "Model Tracker" },
      { href: "/pro/model-transparency", label: "Model Transparency" },
    ],
  },
  nba: {
