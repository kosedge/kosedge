  ...
  return [
    ...
    },
    {
      ...
      links: [
        ...
        {
          href: "/pro/model-tracker",
          label: "Model Tracker",
          hint: "PLAY/LEAN ledger, unit bankroll, ROI, CLV — sport-agnostic desk performance.",
          premium: true,
          status: "active",
        },
      ],
    ...
    sportKey === "cfb"
      ? [
          ...
          },
          {
            ...
            label: "Model Tracker",
            hint: "PLAY/LEAN unit ledger for Week 0–1 — desk performance, not public stake chrome.",
            premium: true,
            status: "active",
          },
          {
