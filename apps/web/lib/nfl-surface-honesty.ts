...
/** Depth charts — packaged/model chart, not live Club Desk. */
export const NFL_DEPTH_SOURCE_NAME = "Packaged model depth chart";

export const NFL_DEPTH_SOURCE_STAMP =
  "Source: packaged model depth chart — not live Club Desk. Named QB1, IR, and claims live on Club Desk.";

export const NFL_DEPTH_NOT_LIVE_CAMP_PHRASE = "not live Club Desk";
 ...
 * When past max_age_days_camp_season, fail closed — point to Club Desk.
 */
export function nflDepthPackFreshnessStamp(
  ...
  return `${base} Pack past ${maxAgeDays}-day camp freshness — QB roles may be stale; named QB1 / IR / claims on Club Desk.`;
}
