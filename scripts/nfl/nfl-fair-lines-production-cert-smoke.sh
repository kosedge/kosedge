...
has "$PUB" "pe_drive_poss_v2" "production target is v2"
has "$PUB" "PENDING_FREEZE" "v2 pending freeze"
...
has "$PACKET" "pe_drive_poss_v2" "packet production target v2"
...
has "$MACHINE" "\"PENDING_FREEZE\"" "machine v2 pending freeze"
