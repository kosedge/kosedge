...
split with a state-conditioned call selector, then replaces the inherited
Gaussian yard draw, explosive-play overlay, and independent turnover branch
for selected designed rushes outside the opponent 20. Every selected
designed rush resolves through one primary outcome: touchdown, lost fumble,
first down, loss, zero gain, or short gain. A lost fumble owns its direct
defensive return transition.
