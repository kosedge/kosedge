...
- **Bundle:** `data/ops/nfl-preseason-sim-2026-20260822T013711Z`
- **Generated:** 2026-08-22T02:11Z
...
| `qb_pass_shape` | **PASS** | 8/96 QBs ≥4000; min=86 (need not 32/32 ≥4000 and min<3200) |
| `top5_rb_spread` | **PASS** | top-5 Half-PPR spread=53.8 (need ≥50) |
...
| `bundle_identity` | **PASS** | nfl-season-engine-2026-preseason-lock · N_team=100000 · 2026-08-22 |
| `pack_vs_fp_clear_error` | **PASS** | CLEAR_ERROR=0 (need 0) |

## Named

- Walker: KC rush=1172.2 RB4 ov21 234.9 Half-PPR
- Charbonnet: SEA rush=960.7 RB12
- Top-5 RB spread: 53.8
- QBs ≥4000: 8
