# NFL launch research sims — 20260822T004326Z

- **Engine:** `nfl-season-engine-v1.27-kicker-layer`
- **Preseason:** yes (honest launch research label)
- **Team W/L sims:** 100,000 (Layers 1–2; win distributions + week matrix)
- **Full player sims:** 1,000 (Layers 1–4 path-coherent)
- **Survivor artifact:** week 1 eval at n=100000
...
- **Output dir:** `/Users/ryankos/kosedge/.worktrees/nfl-spine-worker-hygiene/data/ops/nfl-season-engine-launch-nfl-season-engine-v1.27-kicker-layer-Nteam100000-Nplayer1000-20260822T004326Z`
- **Timing:** team 37.6m · player 16.2m · survivor 0.0m
- **Sanity:** mean_wins_sum=271.9999 (expect ~272)
...
- Team W/L paths reached **100000** (target band 50k–100k).
