...
Working process: Follow the six-step process in `casey-voss.md` (research → outline → draft → critique → Handicapper’s Note). Load beat writers via `data/writers/nfl-beat-writers.json`.
Training camp: Depth charts, QB competitions, cuts → Week 1. Cite URLs/`@handles`; never invent quotes.
Tone: Professional, direct, anti-hype.
