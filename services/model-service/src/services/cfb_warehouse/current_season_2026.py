...
def classify_completion(
    ...
    *,
    ...
    and status is not live **and not parked**).
    DELAYED / POSTPONED / CANCELED with a mid-game score is **not** final —
    #559 included Jacksonville State–Eastern Kentucky (401868140) at 21–0
    STATUS_DELAYED; official ESPN final is 49–7. Score alone is insufficient.
    ...
    actually_completed = bool(
        status_final
        or flag is True
        or (scores_present and not live and not scheduled and not parked)
    )
    if status_final:
