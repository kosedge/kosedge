...
Actually completed = STATUS_FINAL OR (has scores AND not live).
Live / HALFTIME / END_PERIOD / DELAYED-without-score / unfinished are excluded.
"""
    ...
    *,
    ...
    return {
        ...
        "actually_completed_definition": (
            "STATUS_FINAL OR (has scores AND not live status). "
            "Exclude IN_PROGRESS / HALFTIME / END_PERIOD / DELAYED-without-score / unfinished."
        ),
