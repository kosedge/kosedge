...
celery_app.conf.task_routes = {
    ...
    "src.tasks.pull_nba_context_snapshot": {"queue": QUEUE_MODELS, "routing_key": QUEUE_MODELS},
    "src.tasks.pull_nba_schedule_ingest": {"queue": QUEUE_MODELS, "routing_key": QUEUE_MODELS},
    "src.tasks.run_nba_market_simulations": {"queue": QUEUE_MODELS, "routing_key": QUEUE_MODELS},
    "src.tasks.materialize_nba_team_rolling_features": {"queue": QUEUE_MODELS, "routing_key": QUEUE_MODELS},
    "src.tasks.pull_wnba_context_snapshot": {"queue": QUEUE_MODELS, "routing_key": QUEUE_MODELS},
    "src.tasks.pull_wnba_schedule_ingest": {"queue": QUEUE_MODELS, "routing_key": QUEUE_MODELS},
    "src.tasks.pull_wnba_season_ingest": {"queue": QUEUE_MODELS, "routing_key": QUEUE_MODELS},
    "src.tasks.run_wnba_market_simulations": {"queue": QUEUE_MODELS, "routing_key": QUEUE_MODELS},
    "src.tasks.materialize_wnba_team_rolling_features": {"queue": QUEUE_MODELS, "routing_key": QUEUE_MODELS},
    "src.tasks.run_wnba_phase1_bootstrap": {"queue": QUEUE_MODELS, "routing_key": QUEUE_MODELS},
    "src.tasks.run_wnba_phase2_calibrate": {"queue": QUEUE_MODELS, "routing_key": QUEUE_MODELS},
    "src.tasks.run_wnba_phase3_props_bootstrap": {"queue": QUEUE_MODELS, "routing_key": QUEUE_MODELS},
    "src.tasks.materialize_wnba_player_props_edges": {"queue": QUEUE_MODELS, "routing_key": QUEUE_MODELS},
    "src.tasks.run_wnba_daily_cycle": {"queue": QUEUE_MODELS, "routing_key": QUEUE_MODELS},
    "src.tasks.pull_wnba_historical_odds_densify": {"queue": QUEUE_ODDS, "routing_key": QUEUE_ODDS},
