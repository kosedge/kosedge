...
def test_engine_version_includes_survivor_planner_ux() -> None:
    assert ENGINE_VERSION == "nfl-season-engine-v1.12-survivor-planner-ux"
    assert "v1.12" in ENGINE_VERSION
    assert "survivor-planner-ux" in ENGINE_VERSION
