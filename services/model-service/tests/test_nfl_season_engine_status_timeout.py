...
def test_engine_version_includes_v111_calibration() -> None:
    assert ENGINE_VERSION == "nfl-season-engine-v1.11-calibration"
    assert "v1.11" in ENGINE_VERSION
    assert "calibration" in ENGINE_VERSION
