...
**Status:** Chapters 0–2 + 5 merged. Chapter 3 situation apply-on-read (`SITUATION_TEAM_PTS_CAP=3.0`). No KEI / tags / props until Ch4/Ch6. `TEAM_CARRY_SHRINK=0.85` unchanged.  
